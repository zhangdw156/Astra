...
- [x] `2466_workspace-files`
- [x] `3429_unit-convert`
- [x] `1252_financial-calculator`
- [x] `5704_memo-persistent-memory`
- [x] `5403_knowledge-graph`
- [x] `3986_agent-access-control`
- [x] `6834_erpclaw-support`
- [x] `6506_paper-trader`
- [x] `6621_ninebot-device-skill`
- [x] `2720_deep-current`

### Wave 2: fixture-backed program backends

- [x] `1822_code-search`
- [x] `1823_openclaw-code-search`
- [x] `1534_voipms-sms`
- [x] `1939_telnyx`
- [x] `1141_moltx`
- [x] `4435_agentx-news`
- [x] `6734_agentgram`
- [x] `5938_pager-triage`
- [x] `6594_linear-issues`
- [x] `669_stock-strategy-backtester-clean`
- [x] `6723_flightsearch`
- [x] `2142_entur-travel`
- [x] `3581_hackernews`
- [x] `3220_hackernews-cn`
...
- [x] `1104_mem0-1-0-0`
- [x] `2190_qmd-memory`
- [x] `3677_crypto-self-learning`
- [x] `5374_kontour-travel-planner`
- [x] `6287_math-solver`
